...
export const ICONS: Record<string, string> = {
  ...
  card:
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2Z"/><path d="M3 10h18"/></svg>',
  chevronUp:
  ...
  foldV:
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="7 4 12 9 17 4"/><polyline points="7 20 12 15 17 20"/></svg>',
  folderPlus:
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 20h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13c0 1.1.9 2 2 2Z"/><line x1="12" y1="10" x2="12" y2="16"/><line x1="9" y1="13" x2="15" y2="13"/></svg>',
  warn:
  ...
  treeView:
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 5h8"/><path d="M3 12h6"/><path d="M3 19h10"/><path d="M15 5h6"/><path d="M18 5v14"/><path d="M15 19h6"/></svg>',
  listView:
...
export function Raw({ html, class: cls, ...p }: RawProps) {
  return <span class={cls ? `${styles.dcIco} ${cls}` : styles.dcIco} {...p} dangerouslySetInnerHTML={{ __html: html }} />;
}
...
export function EmptyState({ message, icon }: { message: string; icon?: string }) {
  return (
    <div class={styles.emptyState}>
      <div class={styles.emptyIco} dangerouslySetInnerHTML={{ __html: icon || ICONS.folder }} />
      <p>{message}</p>
    </div>
  );
}
